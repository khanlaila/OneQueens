...
const translations = {
  en: {
    ...
    welcome_subtitle:
      "Ask anything. Our AI assistant searches our directory and the web to find resources tailored to you.",
  ...
  es: {
    ...
    welcome_subtitle:
      "Pregunta lo que sea. Nuestro asistente de IA busca en nuestro directorio y en la web para encontrar recursos adaptados a ti.",
  ...
  zh: {
    ...
    welcome_subtitle:
      "任何问题都可以问。我们的人工智能助手会搜索我们的目录和网络，为您找到量身定制的资源。",
  ...
  ko: {
    ...
    welcome_subtitle:
      "무엇이든 물어보세요. AI 어시스턴트가 디렉토리와 웹을 검색하여 맞춤형 자원을 찾아드립니다.",
  ...
  bn: {
    ...
    welcome_subtitle:
      "যা খুশি জিজ্ঞাসা করুন। আমাদের AI সহকারী আমাদের ডিরেক্টরি এবং ওয়েব অনুসন্ধান করে আপনার জন্য উপযুক্ত সম্পদ খুঁজে পেতে সাহায্য করে।",
...
function ChatPage() {
  ...
  const suggestedQuestions =
    t.suggested_questions || translations.en.suggested_questions;
      ...
      <div className="chat-container">
        {!hasMessages && !loading && (
          <div className="welcome">
            ...
            <p className="sub">{t.welcome_subtitle}</p>
                  ...
                  <div className="bubble">
                    <div className="error-box">
                      ...
                      <p className="error-hint">
                        {t.error_hint_prefix}
                        <code>{t.error_hint_command}</code>
                        {t.error_hint_suffix}
                        <code>{t.error_hint_env}</code>
                        {t.error_hint_end}
                      </p>
                    </div>
                  </div>
